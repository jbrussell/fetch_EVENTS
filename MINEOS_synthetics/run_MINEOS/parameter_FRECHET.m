...
param.COMP_prefix = 'BH'; % channel prefix
...
%% Paths for looping through events
param.STAPATH = '../../stations.txt'; % input station path (station file generated by 1-get_event_waveforms.py)
param.CMTPATH = '../../IRIS_ZA_5.5/CMT2idagrn/'; % input CMT path (directory generated by 3-CMT2idagrn.py)
% Data directory (to copy header info)
param.DATAPATH = '../../IRIS_ZA_5.5/';
% New output path for synthetic data
param.NEW_SYNTH_OUT = ['./IRIS_ZA_5.5_MINEOS/',param.CARDID,'_b',num2str(N_modes),'/'];

% DO NOT NEED TO EDIT BELOW THIS LINE
%% Parameters for idagrn synthetics
param.LENGTH_HR = 1.666667; %1.0; % length of seismogram in hours
